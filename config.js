...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "OAJ3GQAJ#Q4UMdA4BR7jAZb4iK-C5t8UwZrPG8PjDKfUYAgwjiZE",
    ...
    AUTHOR: (process.env.PACK_INFO?.split(';') || [])[0] || 'ASAD MD',
    PACKNAME: (process.env.PACK_INFO?.split(';') || [])[1] || '923275374285',
    ...
    OWNER_NAME: process.env.OWNER_NAME || "ASAD", //replace with your name 
    OWNER_NUMBER: process.env.OWNER_NUMBER || "923275374285",// add your bot owner number
    ...
    AUTO_STATUS__MSG: process.env.AUTO_STATUS__MSG || "`𝒚𝒐𝒖𝒓 𝒔𝒕𝒂𝒕𝒖𝒔 𝒔𝒆𝒆𝒏 𝒋𝒖𝒔𝒕 𝒏𝒐𝒘 𝒃𝒚 Asad`",
